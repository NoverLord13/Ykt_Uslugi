...
Теги оставлены для совместимости. Основная классификация теперь делается через категории и подкатегории.
...
| `tag_ids` | int[] | нет | Список ID тегов |
...
При старте приложения выполняется сидинг:

- тегов через `seed_tags()`
- категорий и подкатегорий через `seed_categories()`
