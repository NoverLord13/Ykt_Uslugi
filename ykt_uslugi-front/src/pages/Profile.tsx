  ...
  return <div className="page-shell">
    ...
    <section className="surface relative overflow-hidden p-5 sm:p-8"><div className="absolute -right-20 -top-24 h-64 w-64 rounded-full bg-[var(--brand-soft)] blur-2xl" />
      <div className="relative flex flex-col gap-6 sm:flex-row sm:items-start">
        <div className="grid h-28 w-28 flex-none place-items-center overflow-hidden rounded-[30px] bg-[var(--accent)] text-3xl font-black text-white shadow-xl shadow-blue-200/60">{profile.avatar_url ? <img src={fileUrl(profile.avatar_url)} alt={name} className="h-full w-full object-cover" /> : initials}</div>
